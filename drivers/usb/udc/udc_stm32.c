...
#define UDC_STM32_OTGHS_INSTANCE_DEFINE(inst) UDC_STM32_INSTANCE_DEFINE(DT_DRV_COMPAT_OTGHS, otghs, inst)
#define UDC_STM32_OTGFS_INSTANCE_DEFINE(inst) UDC_STM32_INSTANCE_DEFINE(DT_DRV_COMPAT_OTGFS, otgfs, inst)
#define UDC_STM32_USB_INSTANCE_DEFINE(inst) UDC_STM32_INSTANCE_DEFINE(DT_DRV_COMPAT_USB, usb, inst)
